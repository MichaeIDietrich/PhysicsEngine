...
public final class Outline implements IDrawable
{
    ...
    public void render(Graphics2D g)
    {
        ...
        else if (connectedObject instanceof Polygon)
        {
            ...
            square.moveTo(points[3].getX(), points[3].getY());
            ...
            square.transform(AffineTransform.getRotateInstance(connectedObject.getRotationAngle()));
            square.transform(AffineTransform.getTranslateInstance(connectedObject.getPosition().getX(), 
